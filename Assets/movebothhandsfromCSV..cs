...
public class moveBothHandsFromCSV : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log($"Loaded {listR_WristPos.Count} R wrist frames, {listR_ThumbTipQua.Count} R thumb tip frames.");
        Debug.Log($"Loaded {listL_WristPos.Count} L wrist frames, {listL_ThumbTipQua.Count} L thumb tip frames.");
    }
    ...
    void Update()
    {
        if (listR_WristPos.Count > 0 && fc < listR_WristPos.Count)
        {
        ...
        if (listL_WristPos.Count > 0 && fc < listL_WristPos.Count)
        {
